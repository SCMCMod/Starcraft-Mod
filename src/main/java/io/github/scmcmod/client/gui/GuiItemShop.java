...
import io.github.scmcmod.network.message.MessageSpawnItem;
...
public class GuiItemShop extends BasicGui {
	...
	public void initGui() {
		...
		tabs.add(new ItemShopTab(new ItemStack(StarCraftBlocks.GAS_COLLECTOR, 1, 1),
				I18n.format("itemGroup.terran.machine"), guiLeft - 29, guiTop + 34, GuiLists.TRADES[1]));
		tabs.add(new ItemShopTab(new ItemStack(StarCraftBlocks.PARISTEEL_METAL, 1, 0),
