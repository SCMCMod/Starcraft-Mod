...
public class GuiGasCollector extends GuiContainer
{
	...
	{
		int color = 4210752;
		String title = Item.getItemFromBlock(StarCraftBlocks.GAS_COLLECTOR).getItemStackDisplayName(new ItemStack(StarCraftBlocks.GAS_COLLECTOR, 1, this.te.getType()));
