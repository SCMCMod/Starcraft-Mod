package io.github.scmcmod.recipes.gascollector;
...
public class GasCollectorRecipes
{
	...
	{
		this.addProtossRecipe(StarCraftBlocks.GAS_VESPENE, new ItemStack(ItemHandler.VESPENE, 1, VespeneType.PROTOSS.getID()));
		this.addTerranRecipe(StarCraftBlocks.GAS_VESPENE, new ItemStack(ItemHandler.VESPENE, 1, VespeneType.TERRAN.getID()));
		this.addZergRecipe(StarCraftBlocks.GAS_VESPENE, new ItemStack(ItemHandler.VESPENE, 1, VespeneType.ZERG.getID()));
		this.addProtossRecipe(StarCraftBlocks.GAS_TERRAZINE, new ItemStack(ItemHandler.TERRAZINE, 1, TerrazineType.PROTOSS.getID()));
		this.addTerranRecipe(StarCraftBlocks.GAS_TERRAZINE, new ItemStack(ItemHandler.TERRAZINE, 1, TerrazineType.TERRAN.getID()));
		this.addZergRecipe(StarCraftBlocks.GAS_TERRAZINE, new ItemStack(ItemHandler.TERRAZINE, 1, TerrazineType.ZERG.getID()));
	}
