...
public class ChunkGeneratorChar implements IChunkGenerator
{
	...
	private IBlockState stone = StarCraftBlocks.STONE_CHAR.getDefaultState();
	...
	public ChunkGeneratorChar(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions)
	{
		{
	...
	public void populate(int x, int z)
	{
		...
		if (this.settings.useWaterLakes && this.rand.nextInt(this.settings.waterLakeChance * 100) == 0)
			if (net.minecraftforge.event.terraingen.TerrainGen.populate(this, world, this.rand, x, z, false, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.LAKE))
			{
				...
				(new CharGenCustomLakes(Blocks.WATER)).generate(world, this.rand, blockpos.add(i1, j1, k1));
			}
		...
		if (this.rand.nextInt(this.settings.lavaLakeChance / 10) == 0 && this.settings.useLavaLakes)
			if (net.minecraftforge.event.terraingen.TerrainGen.populate(this, world, this.rand, x, z, false, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.LAVA))
			{
				...
				{
					(new CharGenCustomLakes(Blocks.LAVA)).generate(world, this.rand, blockpos.add(i2, l2, k3));
				}
			}
