...
public class ShakurasGenCaves extends MapGenCaves
{
	...
	protected boolean canReplaceBlock(IBlockState p_175793_1_, IBlockState p_175793_2_)
	{
		...
		return (test == StarCraftBlocks.STONE_SHAKURAS || test == StarCraftBlocks.DIRT_SHAKURAS || test == StarCraftBlocks.SAND_SHAKURAS ? true : (test == Blocks.SAND || test == Blocks.GRAVEL) && p_175793_2_.getMaterial() != Material.LAVA);
	}
}
