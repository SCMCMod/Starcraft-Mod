...
public class BiomeGenShakurasDesert extends BiomeHandler
{
	...
	public BiomeGenShakurasDesert(BiomeProperties id, String name)
	{
		...
		topBlock = StarCraftBlocks.SAND_SHAKURAS.getDefaultState();
		fillerBlock = StarCraftBlocks.SAND_SHAKURAS.getDefaultState();
				...
				{ // If we've hit the ground...
					...
					{ // If we were just in the air...
						...
						} else if (yLoc < seaLevel - 7 - randHeight)
						{
							topBlock = AIR;
							fillerBlock = StarCraftBlocks.STONE_SHAKURAS.getDefaultState();
							chunkPrimerIn.setBlockState(xLoc, yLoc, zLoc, StarCraftBlocks.GRAVEL_SHAKURAS.getDefaultState());
						} else
						{
