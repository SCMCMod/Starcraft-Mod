...
public class ChunkGeneratorZerus implements IChunkGenerator
{
	protected static final IBlockState STONE = StarCraftBlocks.STONE_ZERUS.getDefaultState();
	...
	public ChunkGeneratorZerus(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions)
	{
		{
	...
	public void populate(int x, int z)
	{
		...
		if (biome != BiomeHandler.biomeSlaynProtossCity && this.settings.useWaterLakes && this.rand.nextInt(this.settings.waterLakeChance) == 0)
