...
public class SlaynBiomeProvider extends BiomeProvider
{
	...
	protected SlaynBiomeProvider()
	{
		super();
		biomeCache = new BiomeCache(this);
	}

	private SlaynBiomeProvider(long seed, WorldType worldTypeIn, String options)
	{
		this();
		GenLayer[] agenlayer = GenLayerSlayn.initializeAllBiomeGenerators(seed, worldTypeIn, options);
