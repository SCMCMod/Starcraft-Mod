...
public class BlockZerusFarmland extends BlockFarmland
{
	...
	public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
	{
		...
		if (!this.hasWater(worldIn, pos) && !worldIn.isRainingAt(pos.up()))
		{
			...
			{
				worldIn.setBlockState(pos, StarCraftBlocks.DIRT_ZERUS.getDefaultState());
			}
		} else if (i < 7)
		{
	...
	public void neighborChanged(IBlockState state, World world, BlockPos pos, Block block, BlockPos fromPos)
	{
		...
		{
			world.setBlockState(pos, StarCraftBlocks.DIRT_ZERUS.getDefaultState());
		}
	}
	...
	{
		return StarCraftBlocks.DIRT_ZERUS.getItemDropped(StarCraftBlocks.DIRT_ZERUS.getDefaultState(), rand, fortune);
	}

	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(StarCraftBlocks.DIRT_ZERUS);
	}
