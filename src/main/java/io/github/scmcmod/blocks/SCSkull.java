...
public class SCSkull extends BlockContainer implements IMetaRenderHandler, IMetaBlockName
{
	...
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		...
		return new ItemStack(StarCraftBlocks.STARCRAFT_SKULL, 1, i);
	}
		...
		List<ItemStack> ret = new ArrayList<ItemStack>();
		{
			if (!((Boolean) state.getValue(NODROP)).booleanValue())
			{
				...
				if (tileentity instanceof TileEntityStarcraftSkull)
				{
					...
					ItemStack itemstack = new ItemStack(StarCraftBlocks.STARCRAFT_SKULL, 1, tileentityskull.getSkullType());
					ret.add(itemstack);
				}
			}
		}
	...
	{
		return Item.getItemFromBlock(StarCraftBlocks.STARCRAFT_SKULL);
	}
