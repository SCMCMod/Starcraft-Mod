 ...
 */
public class BlockZergFlesh extends BlockGeneric implements IMetaBlockName, IMetaRenderHandler
{
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	{
		...
		} else if (this.RANDOM.nextInt(100) > 99)
		{
			...
			// worldIn.setBlockState(pos2, StarCraftBlocks.BLOOD.getDefaultState());
		}
