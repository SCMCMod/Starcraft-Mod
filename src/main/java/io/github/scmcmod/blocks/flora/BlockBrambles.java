...
import io.github.scmcmod.client.renderer.particle.ParticleCustomDigging;
		...
		if (state.getBlock() == this)
		{
			if (world.isRemote)
			{
				...
				if (world.getTileEntity(pos) instanceof TileEntityBrambles)
				{
					...
					{
					case KALDIR:
						location = Assets.getTexture("KALDIR_BRAMBLES");
						u = 112;
						v = 112;
						break;
					case SHAKURAS:
						location = Assets.getTexture("SHAKURAS_PALM");
						break;
					case ZERUS:
						location = Assets.getTexture("ZERUS_PALM");
						break;
					}
				}
