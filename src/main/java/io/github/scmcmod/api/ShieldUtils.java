...
import io.github.scmcmod.capabilities.ShieldProvider;
...
public class ShieldUtils
{
	...
	/**
	 * @param player The player to get the shield
	 ...
	 * 
	 * @param player The player to change the shield
	 * @param amount The amount to set the shield to
	 */
