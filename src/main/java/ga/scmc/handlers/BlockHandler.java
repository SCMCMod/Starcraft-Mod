...
public class BlockHandler {
	...
	public static void instantiate() {
		...
		DIRT_CHAR 						= new StarcraftBlock("char.dirt", RegistryType.FULL, Material.ROCK, MapColor.BLACK).setCreativeTab(StarcraftCreativeTabs.MISC).setHardness(0).setResistance(0);
		...
		GRAVEL_CHAR						= new StarcraftBlockFalling("char.gravel", RegistryType.FULL, Material.SAND, MapColor.BLACK, 0000000).setCreativeTab(StarcraftCreativeTabs.MISC).setHardness(0).setResistance(0);
		...
		DIRT_SHAKURAS 					= new StarcraftBlock("shakuras.dirt", RegistryType.FULL, Material.ROCK, MapColor.BLUE).setCreativeTab(StarcraftCreativeTabs.MISC).setHardness(0).setResistance(0);
		...
		GRAVEL_SHAKURAS 				= new StarcraftBlockFalling("shakuras.gravel", RegistryType.FULL, Material.SAND, MapColor.LIGHT_BLUE, 6724056).setCreativeTab(StarcraftCreativeTabs.MISC).setHardness(0).setResistance(0);
		...
		SAND_SHAKURAS 					= new StarcraftBlockFalling("shakuras.sand", RegistryType.FULL, Material.SAND, MapColor.LIGHT_BLUE, 6724056).setCreativeTab(StarcraftCreativeTabs.MISC).setHardness(0).setResistance(0);
