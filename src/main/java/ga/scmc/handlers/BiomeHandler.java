...
public class BiomeHandler extends Biome {
	...
	public static void registerBiomes() {
		...
		biomeCharCreepInfestation = new BiomeGenCharCreepInfestation((new Biome.BiomeProperties("Char Infestation")).setBaseHeight(0.0F).setHeightVariation(0.025F).setTemperature(2.0F).setRainfall(0.3F));
		...
		biomeShakurasCity = new BiomeGenShakurasCity((new Biome.BiomeProperties("Shakuras City")).setBaseHeight(0.0F).setHeightVariation(0).setTemperature(0.3F).setRainfall(0.3F));
