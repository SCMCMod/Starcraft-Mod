...
public class ShapelessRecipes {
	...
	public static void init() {
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ItemHandler.DUST, 2, ItemEnumHandler.DustType.IRON.getID()), "oreIron"));
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ItemHandler.PROTOSS_INGOT, 1, ItemEnumHandler.ProtossIngotType.DARK.getID()), "dyeBlack", new ItemStack(ItemHandler.INGOT, 1, ItemEnumHandler.ProtossIngotType.KHALAI.getID())));
