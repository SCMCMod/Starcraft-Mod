...
public class SmeltingRecipes {
	...
	public static void init() {
		...
		GameRegistry.addSmelting(new ItemStack(ItemHandler.DUST, 1, ItemEnumHandler.DustType.STEEL.getID()), new ItemStack(ItemHandler.INGOT, 1, ItemEnumHandler.IngotType.STEEL.getID()), 0);
		...
		GameRegistry.addSmelting(new ItemStack(BlockHandler.ORE_TITANIUM_CHAR), new ItemStack(ItemHandler.INGOT, 1, ItemEnumHandler.IngotType.TITANIUM.getID()), 0.8F);
		GameRegistry.addSmelting(new ItemStack(BlockHandler.ORE_COPPER_CHAR), new ItemStack(ItemHandler.INGOT, 1, ItemEnumHandler.IngotType.COPPER.getID()), 0.5F);
		...
		GameRegistry.addSmelting(new ItemStack(BlockHandler.ORE_TITANIUM_SHAKURAS), new ItemStack(ItemHandler.INGOT, 1, ItemEnumHandler.IngotType.TITANIUM.getID()), 0.8F);
		GameRegistry.addSmelting(new ItemStack(BlockHandler.ORE_COPPER_SHAKURAS), new ItemStack(ItemHandler.INGOT, 1, ItemEnumHandler.IngotType.COPPER.getID()), 0.5F);
	}
}