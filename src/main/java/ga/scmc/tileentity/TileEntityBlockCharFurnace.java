...
import ga.scmc.container.ContainerFurnaceChar;
 ...
 * @author Ocelot5836
 */
public class TileEntityBlockCharFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
	...
	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
		return new ContainerFurnaceChar(playerInventory, this);
	}
