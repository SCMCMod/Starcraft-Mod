...
import ga.scmc.container.ContainerFurnaceSlayn;
 ...
 * @author Ocelot5836
 */
public class TileEntityBlockSlaynFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
	...
	public void update() {
		...
		if (!this.world.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				BlockFurnaceSlayn.setState(this.isBurning(), this.world, this.pos);
			}
		}
	...
	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
		return new ContainerFurnaceSlayn(playerInventory, this);
	}
