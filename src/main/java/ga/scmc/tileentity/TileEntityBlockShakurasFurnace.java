...
import ga.scmc.container.ContainerFurnaceShakuras;
 ...
 * @author Ocelot5836
 */
public class TileEntityBlockShakurasFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
	...
	public void update() {
		...
		if (!this.world.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				BlockFurnaceShakuras.setState(this.isBurning(), this.world, this.pos);
			}
		}
	...
	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
		return new ContainerFurnaceShakuras(playerInventory, this);
	}
