 ...
 * @author Ocelot5836
 */
public class ContainerFurnaceChar extends Container {
	...
	public ContainerFurnaceChar(InventoryPlayer playerInventory, IInventory furnaceInventory) {
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (index == 2) {
				...
				} else if (TileEntityBlockCharFurnace.isItemFuel(itemstack1)) {
