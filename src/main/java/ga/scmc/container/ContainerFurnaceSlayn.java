 ...
 * @author Ocelot5836
 */
public class ContainerFurnaceSlayn extends Container {
	...
	public ContainerFurnaceSlayn(InventoryPlayer playerInventory, IInventory furnaceInventory) {
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (index == 2) {
				...
				} else if (TileEntityBlockSlaynFurnace.isItemFuel(itemstack1)) {
