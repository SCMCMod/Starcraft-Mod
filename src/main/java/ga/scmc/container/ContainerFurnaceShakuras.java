 ...
 * @author Ocelot5836
 */
public class ContainerFurnaceShakuras extends Container {
	...
	public ContainerFurnaceShakuras(InventoryPlayer playerInventory, IInventory furnaceInventory) {
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (index == 2) {
				...
				} else if (TileEntityBlockShakurasFurnace.isItemFuel(itemstack1)) {
