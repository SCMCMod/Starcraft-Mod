...
public class LayerZerglingSwarmlingColor<T extends EntityZerglingSwarmling> implements LayerRenderer<T> {
	...
	public LayerZerglingSwarmlingColor(RenderZerglingSwarmling<T> rendererIn) {
