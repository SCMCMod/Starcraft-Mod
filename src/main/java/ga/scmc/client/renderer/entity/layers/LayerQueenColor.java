...
public class LayerQueenColor<T extends EntityQueen> implements LayerRenderer<T> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(Resources.QUEEN_OVERLAY);
	private final RenderQueen<T> RENDERER;

	public LayerQueenColor(RenderQueen<T> rendererIn) {
