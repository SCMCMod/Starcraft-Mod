...
public class LayerTyrannozorDehakaColor<T extends EntityTyrannozorDehaka> implements LayerRenderer<T> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(Resources.TYRANNOZORDEHAKA_OVERLAY);
	private final RenderTyrannozorDehaka<T> RENDERER;

	public LayerTyrannozorDehakaColor(RenderTyrannozorDehaka<T> rendererIn) {
