...
public class LayerTyrannozorColor<T extends EntityTyrannozor> implements LayerRenderer<T> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(Resources.TYRANNOZOR_OVERLAY);
	private final RenderTyrannozor<T> RENDERER;

	public LayerTyrannozorColor(RenderTyrannozor<T> rendererIn) {
