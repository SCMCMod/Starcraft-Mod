...
public class LayerNafashColor<T extends EntityNafash> implements LayerRenderer<T> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(Resources.BROODMOTHER_OVERLAY);
	private final RenderNafash<T> RENDERER;

	public LayerNafashColor(RenderNafash<T> rendererIn) {
