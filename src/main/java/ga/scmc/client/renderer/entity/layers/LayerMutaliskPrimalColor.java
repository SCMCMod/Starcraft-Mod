...
public class LayerMutaliskPrimalColor<T extends EntityMutaliskPrimal> implements LayerRenderer<T> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(Resources.MUTALISKPRIMAL_OVERLAY);
	private final RenderMutaliskPrimal<T> RENDERER;

	public LayerMutaliskPrimalColor(RenderMutaliskPrimal<T> rendererIn) {
