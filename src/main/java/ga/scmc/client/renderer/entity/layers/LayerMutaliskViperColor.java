...
public class LayerMutaliskViperColor<T extends EntityMutaliskViper> implements LayerRenderer<T> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(Resources.MUTALISKVIPER_OVERLAY);
	private final RenderMutaliskViper<T> RENDERER;

	public LayerMutaliskViperColor(RenderMutaliskViper<T> rendererIn) {
