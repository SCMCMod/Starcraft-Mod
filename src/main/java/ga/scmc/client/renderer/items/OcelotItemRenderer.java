 ...
 */
public abstract class OcelotItemRenderer implements IPerspectiveAwareModel, IBakedModel {
	...
	public static class ItemRenderList extends ItemOverrideList {
		...
		public IBakedModel handleItemState(IBakedModel originalModel, ItemStack stack, World world, EntityLivingBase entity) {
			if (originalModel instanceof OcelotItemRenderer) {
				OcelotItemRenderer model = (OcelotItemRenderer) originalModel;
	...
	public OcelotItemRenderer(ModelBase model, ResourceLocation resource) {
