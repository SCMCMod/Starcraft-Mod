...
public class ItemRenderRegistrationHandler {
	...
	public static void onModelBake(ModelBakeEvent event) {
		...
		registerItemModel(Item.getItemFromBlock(BlockHandler.FLORA_KALDIR_BRAMBLES), new ItemRenderKaldirBrambles());
		registerItemModel(Item.getItemFromBlock(BlockHandler.FLORA_ZERUS_LIGHTCAP), new ItemRenderZerusLightcap());
