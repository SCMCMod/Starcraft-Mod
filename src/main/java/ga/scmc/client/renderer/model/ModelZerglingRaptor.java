...
public class ModelZerglingRaptor extends ModelBase {
	...
	public ModelZerglingRaptor() {
		...
		setRotateAngle(lbWing3, 0.136659280431156F, 0.0F, 0.0F);
		...
		setRotateAngle(rWing4, 0.18203784098300857F, 0.0F, 0.0F);
		...
		setRotateAngle(lWing4, 0.18203784098300857F, 0.0F, 0.0F);
		...
		setRotateAngle(lbWing4, 0.18203784098300857F, 0.0F, 0.0F);
		...
		setRotateAngle(rbWing4, 0.18203784098300857F, 0.0F, 0.0F);
		...
		setRotateAngle(lWing1, 0.8651597102135892F, 0.091106186954104F, 0.091106186954104F);
		...
		setRotateAngle(rWing3, 0.136659280431156F, 0.0F, 0.0F);
		...
		setRotateAngle(rWing1, 0.8651597102135892F, -0.091106186954104F, -0.091106186954104F);
		...
		setRotateAngle(rbWing3, 0.136659280431156F, 0.0F, 0.0F);
		...
		setRotateAngle(rbWing1, 0.5009094953223726F, -0.18203784098300857F, -0.22759093446006054F);
		...
		setRotateAngle(lWing3, 0.136659280431156F, 0.0F, 0.0F);
		...
		setRotateAngle(lbWing1, 0.5009094953223726F, 0.18203784098300857F, 0.18203784098300857F);
