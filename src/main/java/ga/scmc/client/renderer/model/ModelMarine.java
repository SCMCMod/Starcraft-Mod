...
public class ModelMarine extends ModelBiped {
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		GlStateManager.translate(this.rInsignia2.rotationPointX * f5, this.rInsignia2.rotationPointY * f5, this.rInsignia2.rotationPointZ * f5);
		GlStateManager.scale(0.3D, 0.3D, 0.3D);
		GlStateManager.translate(-this.rInsignia2.offsetX, -this.rInsignia2.offsetY, -this.rInsignia2.offsetZ);
		GlStateManager.translate(-this.rInsignia2.rotationPointX * f5, -this.rInsignia2.rotationPointY * f5, -this.rInsignia2.rotationPointZ * f5);
		this.rInsignia2.render(f5);
		GlStateManager.popMatrix();
		this.bipedRightLeg.render(f5);
		GlStateManager.pushMatrix();
		GlStateManager.translate(this.rInsignia.offsetX, this.rInsignia.offsetY, this.rInsignia.offsetZ);
		GlStateManager.translate(this.rInsignia.rotationPointX * f5, this.rInsignia.rotationPointY * f5, this.rInsignia.rotationPointZ * f5);
		GlStateManager.scale(0.3D, 0.3D, 0.2D);
		GlStateManager.translate(-this.rInsignia.offsetX, -this.rInsignia.offsetY, -this.rInsignia.offsetZ);
		GlStateManager.translate(-this.rInsignia.rotationPointX * f5, -this.rInsignia.rotationPointY * f5, -this.rInsignia.rotationPointZ * f5);
		this.rInsignia.render(f5);
		GlStateManager.popMatrix();
		GlStateManager.pushMatrix();
		GlStateManager.translate(this.lInsignia2.offsetX, this.lInsignia2.offsetY, this.lInsignia2.offsetZ);
		GlStateManager.translate(this.lInsignia2.rotationPointX * f5, this.lInsignia2.rotationPointY * f5, this.lInsignia2.rotationPointZ * f5);
		GlStateManager.scale(0.3D, 0.3D, 0.3D);
		GlStateManager.translate(-this.lInsignia2.offsetX, -this.lInsignia2.offsetY, -this.lInsignia2.offsetZ);
		GlStateManager.translate(-this.lInsignia2.rotationPointX * f5, -this.lInsignia2.rotationPointY * f5, -this.lInsignia2.rotationPointZ * f5);
		this.lInsignia2.render(f5);
		GlStateManager.popMatrix();
		GlStateManager.pushMatrix();
		GlStateManager.translate(this.lInsignia.offsetX, this.lInsignia.offsetY, this.lInsignia.offsetZ);
		GlStateManager.translate(this.lInsignia.rotationPointX * f5, this.lInsignia.rotationPointY * f5, this.lInsignia.rotationPointZ * f5);
		GlStateManager.scale(0.3D, 0.3D, 0.2D);
		GlStateManager.translate(-this.lInsignia.offsetX, -this.lInsignia.offsetY, -this.lInsignia.offsetZ);
		GlStateManager.translate(-this.lInsignia.rotationPointX * f5, -this.lInsignia.rotationPointY * f5, -this.lInsignia.rotationPointZ * f5);
		this.lInsignia.render(f5);
		GlStateManager.popMatrix();
