...
public class ModelTerranMarineArmorT1 extends ModelArmorBase implements IArmorItem {
	...
	public ModelTerranMarineArmorT1(float modelSize) {
		...
		this.lHandGuard.addBox(-0.9F, 8.2F, -2.39F, 4, 2, 5, 0.0F);
		...
		this.rHandGuard.addBox(-3.1F, 8.2F, -2.39F, 4, 2, 5, 0.0F);
	...
	protected void renderArmorModel(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
		super.renderArmorModel(entity, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scale);
	}
