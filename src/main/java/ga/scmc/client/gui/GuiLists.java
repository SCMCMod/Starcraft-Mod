...
public class GuiLists {
	...
	/** @deprecated Use the {@link LogRegistry} instead of this. It handles logs much, much better. */
	...
	static {
		...
		tab0.add(new Product(ItemMagazine.getDefaultStack(EnumMetaItem.BulletMagazineType.C14.getID()), 6, 0));
		tab0.add(new Product(ItemMagazine.getDefaultStack(EnumMetaItem.BulletMagazineType.FLAMETHROWER.getID()), 8, 0));
		...
		for (int i = 0; i < ParisteelMetalType.values().length; i++)
			tab2.add(new Product(new ItemStack(MetaBlockHandler.PARISTEEL_METAL, 1, i), 1, 0));
		for (int i = 0; i < NeosteelMetalType.values().length; i++)
			tab2.add(new Product(new ItemStack(MetaBlockHandler.NEOSTEEL_METAL, 1, i), 1, 0));
		tab2.add(new Product(new ItemStack(BlockHandler.TERRAN_WARNING_TAPE, 1, 0), 1, 0));
		TRADES[2] = tab2.build();
		...
		tab4.add(new Product(new ItemStack(ArmorHandler.TERRAN_MARINE_T3_HELMET, 1, 0), 16, 12));
		tab4.add(new Product(new ItemStack(ArmorHandler.TERRAN_MARINE_T3_CHESTPLATE, 1, 0), 24, 16));
		tab4.add(new Product(new ItemStack(ArmorHandler.TERRAN_MARINE_T3_LEGGINGS, 1, 0), 20, 14));
		tab4.add(new Product(new ItemStack(ArmorHandler.TERRAN_MARINE_T3_BOOTS, 1, 0), 16, 12));
		TRADES[4] = tab4.build();
