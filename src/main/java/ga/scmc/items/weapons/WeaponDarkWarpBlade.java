...
public class WeaponDarkWarpBlade extends ItemSword {
	...
	public WeaponDarkWarpBlade(ToolMaterial material) {
		super(material);
		setUnlocalizedName("darkWarpBlade");
		setRegistryName("dark_warp_blade");
	...
	public void checkCanReplace(EntityPlayer player, ItemStack stack) {
		...
		player.inventory.addItemStackToInventory(new ItemStack(ItemHandler.PSI_BLADE_FOCUSER_UNCHARGED, 1, ItemEnumHandler.FocuserType.DARK.getID()));
	}
