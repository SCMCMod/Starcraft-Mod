...
public class ModelHydralisk extends ModelBase {
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
		...
		tail05.rotateAngleY = MathHelper.cos(par1 * 1.0F) * 0.337F * par2;
		tail06.rotateAngleY = MathHelper.cos(par1 * 1.0F) * 0.227F * par2;
		tail07.rotateAngleY = MathHelper.sin(par1 * 1.0F) * 0.117F * par2;
		tail08.rotateAngleY = MathHelper.sin(par1 * 1.0F) * 0.057F * par2;
		tail09.rotateAngleY = MathHelper.cos(par1 * 1.0F) * 0.027F * par2;
