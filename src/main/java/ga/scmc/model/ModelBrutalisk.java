...
public class ModelBrutalisk extends ModelBase implements IModelSkull {
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
		...
		this.tail1.rotateAngleX = MathHelper.cos(par1 * 0.7F) * 0.667F * par2 + 0.5F;
		this.tail2.rotateAngleX = MathHelper.sin(par1 * 0.7F) * 0.337F * par2 + 0.5F;
		this.tail3.rotateAngleX = MathHelper.sin(par1 * 0.7F) * 0.337F * par2;
		this.laLeg1.rotateAngleX = (MathHelper.sin(par1 * 0.5F) / 4.1F) * 2.0F * par2;
		this.laLeg1.rotateAngleY = (MathHelper.sin(par1 * 0.5F) / 4.1F) * 2.0F * par2 + 0.5F;
		this.raLeg1.rotateAngleX = (MathHelper.cos(par1 * 0.5F) / 4.1F) * 2.0F * par2;
		this.raLeg1.rotateAngleY = (MathHelper.cos(par1 * 0.5F) / 4.1F) * 2.0F * par2 - 0.5F;
		this.laLeg1.rotateAngleZ = -0.5F;
		this.raLeg1.rotateAngleZ = 0.5F;
		this.lbLeg1.rotateAngleX = (MathHelper.sin(par1 * 0.5F) / 4.1F) * 2.0F * par2;
		this.lbLeg1.rotateAngleY = (MathHelper.sin(par1 * 0.5F) / 4.1F) * 2.0F * par2;
		this.lcLeg1.rotateAngleX = (MathHelper.cos(par1 * 0.5F) / 4.1F) * 2.0F * par2;
		this.lcLeg1.rotateAngleY = (MathHelper.cos(par1 * 0.5F) / 4.1F) * 2.0F * par2;
		this.rbLeg1.rotateAngleX = (MathHelper.cos(par1 * 0.5F) / 4.1F) * 2.0F * par2;
		this.rbLeg1.rotateAngleY = (MathHelper.cos(par1 * 0.5F) / 4.1F) * 2.0F * par2;
