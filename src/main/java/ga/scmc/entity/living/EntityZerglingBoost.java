 ...
 * @author Hypeirochus
 */
public class EntityZerglingBoost extends EntityZergMob implements IMob, Predicate<EntityLivingBase> {
	...
	protected void applyEntityAttributes() {
		...
		getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.4456D);
