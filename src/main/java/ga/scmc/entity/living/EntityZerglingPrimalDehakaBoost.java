 ...
 * @author Hypeirochus
 */
public class EntityZerglingPrimalDehakaBoost extends EntityZergMob implements IMob, Predicate<EntityLivingBase> {

	public EntityZerglingPrimalDehakaBoost(World world) {
		super(world);
		setSize(1.0F, 1.0F);
