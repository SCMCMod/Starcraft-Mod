...
public class EntityMutaliskBroodlord extends EntityZergFlying implements IMob {
	...
	public EntityMutaliskBroodlord(World world) {
		...
		this.moveHelper = new EntityMutaliskBroodlord.MutaliskMoveHelper(this);
		this.tasks.addTask(5, new EntityMutaliskBroodlord.AIRandomFly(this));
		this.tasks.addTask(7, new EntityMutaliskBroodlord.AILookAround(this));
