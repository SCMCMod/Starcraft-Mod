...
public class EntityMutaliskBroodlord extends EntityZergFlying implements IMob, IRangedAttackMob, Predicate<EntityLivingBase> {

	public EntityMutaliskBroodlord(World world) {
		super(world);
		setSize(4.0F, 1.5F);
		...
		moveHelper = new EntityMutaliskBroodlord.MutaliskMoveHelper(this);
		tasks.addTask(2, new EntityAIAttackRanged(this, 1.0D, 40, 20.0F));
		tasks.addTask(5, new EntityMutaliskBroodlord.AIRandomFly(this));
		tasks.addTask(7, new EntityMutaliskBroodlord.AILookAround(this));
	...
	static class AILookAround extends EntityAIBase {
		private final EntityMutaliskBroodlord parentEntity;

		public AILookAround(EntityMutaliskBroodlord kakaru) {
	...
	static class AIRandomFly extends EntityAIBase {
		...
		public AIRandomFly(EntityMutaliskBroodlord kakaru) {
			this.parentEntity = kakaru;
			this.setMutexBits(1);
		}
	...
	static class MutaliskMoveHelper extends EntityMoveHelper {
		...
		public MutaliskMoveHelper(EntityMutaliskBroodlord kakaru) {
			super(kakaru);
			this.parentEntity = kakaru;
		}
