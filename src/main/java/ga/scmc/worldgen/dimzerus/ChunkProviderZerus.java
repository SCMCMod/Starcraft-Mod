...
public class ChunkProviderZerus implements IChunkGenerator {
	...
	public ChunkProviderZerus(World worldIn, long seed, boolean mapFeaturesEnabledIn, String p_i46668_5_) {
		{
