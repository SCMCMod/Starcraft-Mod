...
public class ZerusWorldGenMinable extends WorldGenerator {
	...
	public ZerusWorldGenMinable(IBlockState state, int blockCount) {
		this(state, blockCount, BlockMatcher.forBlock(BlockHandler.STONE_ZERUS));
	}

	public ZerusWorldGenMinable(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_) {
		oreBlock = state;
