...
public class GenLayerShakurasBiomes extends GenLayer {
	...
	public Biome[] dimBiomes = { BiomeHandler.biomeShakurasDesert, BiomeHandler.biomeShakurasHills, BiomeHandler.biomeShakurasOcean, BiomeHandler.biomeShakurasMountains};
