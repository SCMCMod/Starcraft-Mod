...
public class AiurWorldGenMinable extends WorldGenerator {
	...
	public AiurWorldGenMinable(IBlockState state, int blockCount) {
		this(state, blockCount, BlockMatcher.forBlock(Blocks.STONE));
	}

	public AiurWorldGenMinable(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_) {
		oreBlock = state;
