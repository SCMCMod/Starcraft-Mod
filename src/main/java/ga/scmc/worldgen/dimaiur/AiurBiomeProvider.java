...
public class AiurBiomeProvider extends BiomeProvider {
	...
	protected AiurBiomeProvider() {
		super();
		biomeCache = new BiomeCache(this);
	}

	private AiurBiomeProvider(long seed, WorldType worldTypeIn, String options) {
		this();
		GenLayer[] agenlayer = GenLayerAiur.initializeAllBiomeGenerators(seed, worldTypeIn, options);
