...
public class BlockSlaynOre extends StarcraftBlock {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return this == BlockHandler.ORE_COAL_SLAYN ? Items.COAL : (this == BlockHandler.ORE_DIAMOND_SLAYN ? Items.DIAMOND : (this == BlockHandler.ORE_LAPIS_SLAYN ? Items.DYE : (this == BlockHandler.ORE_PHOSPHORUS_SLAYN ? ItemHandler.PHOSPHORUS : (this == BlockHandler.ORE_RICHMINERAL_SLAYN || this == BlockHandler.ORE_MINERAL_SLAYN ? ItemHandler.MINERAL_SHARD : Item.getItemFromBlock(this)))));
	}
