...
public class OreShakurasRedstone extends Block {
	...
	public OreShakurasRedstone(boolean isOn) {
		...
		if (isOn) {
			setUnlocalizedName("shakurasOreRedstoneLit");
			setRegistryName("shakuras_ore_redstone_lit");
			setLightLevel(.625f);
			this.setTickRandomly(true);
		} else {
			setUnlocalizedName("shakurasOreRedstone");
			setRegistryName("shakuras_ore_redstone");
