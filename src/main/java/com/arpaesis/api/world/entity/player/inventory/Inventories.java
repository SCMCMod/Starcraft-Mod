package com.arpaesis.api.world.entity.player.inventory;
...
public class Inventories
{
	...
	/**
	 * Creates an itemStack instance from a random selection of Item objects in an
	 * array, with a stack amount of 1.
	 *
	 * @param items - List of Items to choose a random Item from.
	 * @return an ItemStack instance instantiated from a random Item chosen from the
	 *         provided Item Array.
	 */
	...
	/**
	 * Takes in either a Block or Item and creates a stack of it with an amount of
	 * 1.
	 *
	...
	/**
	 * Takes in either a Block or Item and creates a stack of it with the specified
	 * amount.
	 *
	 * @param obj - Item or Block instance.
	...
	/**
	 * Consumes a single item of the specified type from the specified player's
	 * inventory. Only comsumes an item if the player is in survival mode.
	 *
	...
	/**
	 * Consumes a single item of the specified type from the specified player's
	 * inventory. Only comsumes an item if the player is in survival mode, unless
	 * forced.
	 *
	 * @param player - The player to consume an item from.
	 * @param item - The item to consume.
	...
	/**
	 * Checks if a player has an item with the given amount. Searches for items with
