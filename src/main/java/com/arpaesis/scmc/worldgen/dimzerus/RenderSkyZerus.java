...
public class RenderSkyZerus extends IRenderHandler
{
	...
	{
		if (world.provider instanceof WorldProviderZerus)
		{
			WorldProviderZerus provider = (WorldProviderZerus) world.provider;
