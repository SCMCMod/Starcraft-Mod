...
public class ModelDarkProbe extends Model
{
	...
	public ModelDarkProbe()
	{
		...
		this.setRotation(curvedHorn01, -0.18203784098300857F, 0.0F, 0.0F);
		...
		this.setRotation(rWing12B, -0.40980330836826856F, 0.0F, 0.0F);
		...
		this.setRotation(lWing09, -0.9560913642424937F, 0.27314402793711257F, 0.31869712141416456F);
		...
		this.setRotation(lWing11, 0.31869712141416456F, 0.091106186954104F, -0.5918411493512771F);
		...
		this.setRotation(rWing09, -1.0016444577195458F, -0.27314402793711257F, -0.31869712141416456F);
		...
		this.setRotation(lWing12B, -0.40980330836826856F, 0.0F, 0.0F);
		...
		this.setRotation(lWing11B, -0.18203784098300857F, -0.136659280431156F, -0.5918411493512771F);
		...
		this.setRotation(rWing11B, -0.18203784098300857F, 0.136659280431156F, 0.5918411493512771F);
		...
		this.setRotation(curvedHorn02, 0.4553564018453205F, 0.0F, 0.0F);
		...
		this.setRotation(rWing11, 0.31869712141416456F, -0.091106186954104F, 0.5918411493512771F);
