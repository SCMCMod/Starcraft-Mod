package com.arpaesis.scmc.client.model;
...
public interface IArmorItem
{
	 ...
	 * 
	 * @param type The transformation that is being used
	 * @param entity The entity that is rendering the armor part
	 * @param scale The scale of the armor model
	 */
