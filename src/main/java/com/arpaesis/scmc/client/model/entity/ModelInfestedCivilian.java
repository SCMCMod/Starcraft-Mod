...
/**
 * infestedterran - XJustaguyX Created using Tabula 5.1.0
 */
public class ModelInfestedCivilian extends Model
{
	...
	public ModelInfestedCivilian()
	{
		...
		setRotation(rUpperTentacle03, 0.2617993877991494F, 0.0F, 0.0F);
		...
		setRotation(rTentacle03, 0.3490658503988659F, 0.0F, 0.0F);
		...
		setRotation(lUpperTentacle03, 0.2617993877991494F, 0.0F, 0.0F);
		...
		setRotation(shoulder_right, 0.0F, 0.0F, 0.17453292519943295F);
		...
		setRotation(rFaceTentacle1, 0.8651597102135892F, 0.17453292519943295F, 0.0F);
		...
		setRotation(rUpperTentacle04, 0.6108652381980153F, 0.0F, 0.0F);
		...
		setRotation(lFaceTentacle2, 0.6457718232379019F, 0.014660765716752367F, -0.00942477796076938F);
		lFoot = new ModelRenderer(this, 0, 53);
		lFoot.setRotationPoint(0.0F, 9.6F, 0.0F);
		lFoot.addBox(-3.0F, 0.0F, -5.7F, 6, 3, 9, 0.0F);
		setRotation(lFoot, 0.18203784098300857F, 0.0041887902047863905F, 0.136659280431156F);
		...
		setRotation(rUpperSpike02, 0.22759093446006054F, 0.0F, 0.0F);
		...
		setRotation(hand_left, 0.18203784098300857F, 0.016406094968746697F, 0.2452187599052033F);
		...
		setRotation(lUpperSpike02, 0.22759093446006054F, 0.0F, 0.0F);
		...
		setRotation(faceTumor02, 0.0F, 0.2617993877991494F, 0.19198621771937624F);
		...
		setRotation(rUpperSpike01, 0.31869712141416456F, 0.0F, 0.0F);
		...
		setRotation(lTentacle03, 0.3490658503988659F, 0.0F, -0.017453292519943295F);
		...
		setRotation(arm_upper_right, 0.0F, 0.0F, 0.06981317007977318F);
		...
		setRotation(arm_lower_right, -0.47123889803846897F, 0.0F, 0.017453292519943295F);
		...
		setRotation(rTentacle01, -0.22759093446006054F, 0.36425021489121656F, -0.4363323129985824F);
		...
		setRotation(rFaceTentacle5, 0.08726646259971647F, 0.0F, 0.0F);
		rFinger1A = new ModelRenderer(this, 0, 27);
		rFinger1A.setRotationPoint(0.0F, 3.7F, -1.3F);
		rFinger1A.addBox(-1.0F, 0.0F, -0.5F, 2, 4, 1, 0.0F);
		setRotation(rFinger1A, -0.22549653935766736F, -0.007853981633974483F, 0.015533430342749534F);
		...
		setRotation(lSpike01, 0.18203784098300857F, 0.0F, 0.0F);
		...
		setRotation(lUpperSpike03, 0.22759093446006054F, 0.0F, 0.0F);
		...
		setRotation(lToeClaw1, -0.40980330836826856F, 0.0F, 0.0F);
		...
		setRotation(faceTumor07, -0.10471975511965977F, -0.091106186954104F, 0.31869712141416456F);
		rSpike02 = new ModelRenderer(this, 75, 40);
		rSpike02.setRotationPoint(-0.5F, -1.6F, 0.0F);
		rSpike02.addBox(-1.0F, -2.0F, -1.0F, 2, 2, 2, 0.0F);
		setRotation(rSpike02, 0.091106186954104F, 0.0F, 0.0F);
		...
		setRotation(rUpperTentacle01, 0.18203784098300857F, -0.36425021489121656F, 0.4553564018453205F);
		rSpike03 = new ModelRenderer(this, 78, 41);
		rSpike03.setRotationPoint(0.0F, -1.6F, 0.0F);
		rSpike03.addBox(-0.5F, -2.0F, -0.5F, 1, 2, 1, 0.0F);
		setRotation(rSpike03, 0.136659280431156F, 0.0F, 0.0F);
		...
		setRotation(lUpperSpike01, 0.31869712141416456F, 0.0F, 0.0F);
		...
		setRotation(faceTumor05, -0.15707963267948966F, 0.06981317007977318F, 0.8552113334772213F);
		rSpike01 = new ModelRenderer(this, 75, 40);
		rSpike01.setRotationPoint(0.0F, -1.6F, 0.0F);
		rSpike01.addBox(-1.5F, -2.0F, -1.5F, 2, 2, 3, 0.0F);
		setRotation(rSpike01, 0.18203784098300857F, 0.0F, 0.0F);
		...
		setRotation(faceTumor04, 0.0F, 0.2617993877991494F, 0.7330382858376184F);
		...
		setRotation(lArmUpper, 0.0F, 0.0F, 0.06981317007977318F);
		...
		setRotation(faceTumor01, 0.05235987755982988F, -0.22689280275926282F, 1.0821041362364843F);
		lClaw3 = new ModelRenderer(this, 0, 21);
		lClaw3.setRotationPoint(-0.2F, 3.4F, 0.1F);
		lClaw3.addBox(-0.5F, 0.0F, -0.5F, 1, 3, 1, 0.0F);
		setRotation(lClaw3, 0.04276056667386108F, -0.034033920413889425F, -0.41119957176986405F);
		...
		setRotation(rFaceTentacle4, 0.2617993877991494F, 0.0F, 0.0F);
		...
		setRotation(lKnee, 1.2747884856566583F, -0.091106186954104F, 0.0F);
		...
		setRotation(lShoulder, 0.0F, 0.0F, -0.296705972839036F);
		rFinger2A = new ModelRenderer(this, 0, 27);
		rFinger2A.setRotationPoint(0.0F, 3.7F, 0.6F);
		rFinger2A.addBox(-1.0F, 0.0F, -0.5F, 2, 4, 1, 0.0F);
		setRotation(rFinger2A, 0.08272860654453122F, -0.06806784082777885F, 0.15795229730548682F);
		...
		setRotation(lTentacle05, 0.6108652381980153F, 0.0F, 0.0F);
		...
		setRotation(lFaceTentacle3, 0.2617993877991494F, 0.0F, 0.0F);
		...
		setRotation(lUpperTentacle02, 0.3490658503988659F, 0.0F, 0.0F);
		...
		setRotation(rTentacle02, 0.0F, 0.0F, -0.8726646259971648F);
		...
		setRotation(faceTumor09, 0.091106186954104F, -0.27314402793711257F, 0.03490658503988659F);
		rClaw1A = new ModelRenderer(this, 0, 21);
		rClaw1A.setRotationPoint(0.0F, 3.7F, 0.0F);
		rClaw1A.addBox(-0.5F, 0.0F, -0.3F, 1, 3, 1, 0.0F);
		setRotation(rClaw1A, -0.09686577348568529F, 0.01832595714594046F, -0.478918346747244F);
		...
		setRotation(rTentacle05, 0.5235987755982988F, 0.0F, 0.0F);
		...
		setRotation(rTentacle05_1, 0.6108652381980153F, 0.0F, 0.0F);
		...
		setRotation(lUpperTentacle04, 0.6108652381980153F, 0.0F, 0.0F);
		rFinger3 = new ModelRenderer(this, 0, 27);
		rFinger3.setRotationPoint(1.4F, 1.0F, -1.1F);
		rFinger3.addBox(-1.0F, 0.0F, -0.5F, 2, 4, 1, 0.0F);
		setRotation(rFinger3, -0.091106186954104F, 0.2707005669843205F, -0.36425021489121656F);
		...
		setRotation(lTentacle04, 0.2617993877991494F, 0.0F, 0.0F);
		lFinger2A = new ModelRenderer(this, 0, 27);
		lFinger2A.setRotationPoint(0.0F, 3.7F, 0.6F);
		lFinger2A.addBox(-1.0F, 0.0F, -0.5F, 2, 4, 1, 0.0F);
		setRotation(lFinger2A, 0.08272860654453122F, -0.06806784082777885F, -0.15795229730548682F);
		...
		setRotation(rToe2, -0.03490658503988659F, 0.0F, 0.0F);
		...
		setRotation(rToeClaw2, -0.40980330836826856F, 0.0F, 0.0F);
		...
		setRotation(lUpperTentacle01, 0.091106186954104F, 0.0F, -0.5918411493512771F);
		rFoot = new ModelRenderer(this, 0, 53);
		rFoot.mirror = true;
		rFoot.setRotationPoint(0.0F, 9.6F, 0.0F);
		rFoot.addBox(-3.0F, 0.0F, -5.7F, 6, 3, 9, 0.0F);
		setRotation(rFoot, 0.18203784098300857F, 0.0041887902047863905F, -0.136659280431156F);
		...
		setRotation(lHip, -0.15707963267948966F, 0.0F, 1.0821041362364843F);
		...
		setRotation(faceTumor06, -0.03490658503988659F, 0.06981317007977318F, 0.40980330836826856F);
		...
		setRotation(lFinger1A, -0.22549653935766736F, -0.007853981633974483F, 0.015533430342749534F);
		lClaw1A = new ModelRenderer(this, 0, 21);
		lClaw1A.setRotationPoint(0.0F, 3.7F, -0.1F);
		lClaw1A.addBox(-0.5F, 0.0F, -0.3F, 1, 3, 1, 0.0F);
		setRotation(lClaw1A, -0.09686577348568529F, 0.01832595714594046F, 0.18430676901060122F);
		lSpike = new ModelRenderer(this, 32, 57);
		lSpike.setRotationPoint(3.4F, -11.0F, -1.5F);
		lSpike.addBox(0.0F, -2.5F, 0.0F, 0, 5, 10, 0.0F);
		setRotation(lSpike, 2.0943951023931953F, -0.31869712141416456F, 0.22759093446006054F);
		...
		setRotation(rFaceTentacle3, 0.31869712141416456F, 0.0F, 0.0F);
		rKnee = new ModelRenderer(this, 0, 35);
		rKnee.mirror = true;
		rKnee.setRotationPoint(0.5F, 7.5F, -0.8F);
		rKnee.addBox(-2.5F, 0.0F, -2.5F, 5, 9, 5, 0.0F);
		setRotation(rKnee, 1.2747884856566583F, 0.091106186954104F, 0.0F);
		...
		setRotation(rUpperSpike03, 0.22759093446006054F, 0.0F, 0.0F);
		...
		setRotation(lToeClaw2, -0.40980330836826856F, 0.0F, 0.0F);
		...
		setRotation(lTentacle06, 0.5235987755982988F, 0.0F, 0.0F);
		...
		setRotation(faceTumor08, 0.0F, 0.27314402793711257F, 0.15707963267948966F);
		finger31 = new ModelRenderer(this, 0, 21);
		finger31.setRotationPoint(0.2F, 3.4F, 0.1F);
		finger31.addBox(-0.5F, 0.0F, -0.5F, 1, 3, 1, 0.0F);
		setRotation(finger31, 0.04276056667386108F, -0.034033920413889425F, 0.41119957176986405F);
		...
		setRotation(lFaceTentacle1, 0.5009094953223726F, -0.5410520681182421F, 0.0F);
		...
		setRotation(faceTumor03, -0.06981317007977318F, -0.15707963267948966F, 0.6981317007977318F);
		...
		setRotation(lFaceTentacle4, 0.08726646259971647F, 0.0F, 0.0F);
		...
		setRotation(hand_right, 0.18203784098300857F, 0.016406094968746697F, -0.2452187599052033F);
		...
		setRotation(rTentacle06, 0.5235987755982988F, 0.0F, 0.0F);
		lFinger3 = new ModelRenderer(this, 0, 27);
		lFinger3.setRotationPoint(-1.4F, 1.0F, -1.1F);
		lFinger3.addBox(-1.0F, 0.0F, -0.5F, 2, 4, 1, 0.0F);
		setRotation(lFinger3, -0.091106186954104F, 0.2707005669843205F, 0.38275070496235647F);
		...
		setRotation(rTentacle04, 0.2617993877991494F, 0.0F, 0.0F);
		rThigh = new ModelRenderer(this, 65, 48);
		rThigh.mirror = true;
		rThigh.setRotationPoint(-3.0F, 5.0F, 0.0F);
		rThigh.addBox(-2.0F, -0.2F, -2.5F, 5, 11, 5, 0.0F);
		setRotation(rThigh, -0.40980330836826856F, 0.0F, 0.22759093446006054F);
		...
		setRotation(rUpperTentacle02, 0.3490658503988659F, 0.0F, -0.017453292519943295F);
		rClaw2A = new ModelRenderer(this, 0, 21);
		rClaw2A.setRotationPoint(0.0F, 3.7F, -0.1F);
		rClaw2A.addBox(-0.5F, 0.0F, -0.3F, 1, 3, 1, 0.0F);
		setRotation(rClaw2A, -0.09686577348568529F, 0.01832595714594046F, -0.478918346747244F);
		...
		setRotation(rFaceTentacle2, 0.091106186954104F, 0.0F, 0.0F);
		...
		setRotation(faceTumor10, -0.10471975511965977F, -0.091106186954104F, 0.05235987755982988F);
		rHip = new ModelRenderer(this, 23, 36);
		rHip.mirror = true;
		rHip.setRotationPoint(-4.0F, 4.0F, 0.0F);
		rHip.addBox(-0.6F, -2.1F, -2.7F, 2, 7, 6, 0.0F);
		setRotation(rHip, -0.15707963267948966F, 0.0F, -1.0821041362364843F);
		...
		setRotation(lTentacle01, 0.0F, 0.0F, 0.9773843811168246F);
	...
	public void render(Object obj)
	{
		...
		head.rotateAngleX = headPitch(obj) * 0.017453292F + 6.5F;
		head.rotateAngleY = headYaw(obj) * 0.017453292F;
		this.lThigh.rotateAngleX = MathHelper.sin(swingProgress(obj) * 1) * 0.6F * swingProgressPrev(obj) + 5.9F;
		this.lArmUpper.rotateAngleX = MathHelper.cos(swingProgress(obj) * 0.6662F) * 0.5F * swingProgressPrev(obj);
		this.rThigh.rotateAngleX = MathHelper.cos(swingProgress(obj) * 1) * 0.6F * swingProgressPrev(obj) + 5.9F;
		this.arm_upper_right.rotateAngleX = MathHelper.sin(swingProgress(obj) * 0.8F) * 0.5F * swingProgressPrev(obj);
	}
}