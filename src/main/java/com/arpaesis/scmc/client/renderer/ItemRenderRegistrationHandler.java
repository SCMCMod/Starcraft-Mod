...
import com.arpaesis.scmc.client.renderer.item.ItemRenderBrambles;
import com.arpaesis.scmc.client.renderer.item.ItemRenderC14GaussRifle;
import com.arpaesis.scmc.client.renderer.item.ItemRenderFlamethrower;
import com.arpaesis.scmc.client.renderer.item.ItemRenderModelArmorItem;
import com.arpaesis.scmc.client.renderer.item.ItemRenderSolariteReaper;
import com.arpaesis.scmc.client.renderer.item.ItemRenderStarcraftSkull;
import com.arpaesis.scmc.client.renderer.item.ItemRenderZerusGlowPod;
import com.arpaesis.scmc.client.renderer.item.ItemRenderZerusLightcap;
