package com.arpaesis.scmc.entity.vehicles;
...
import com.arpaesis.scmc.vehicles.weapons.VehicleWeapon;
...
public class EntitySpaceship extends Entity
{
	...
	/**
	 * How much the ship should glide given the slippery blocks it's currently
	 ...
	 * blocks. This enables the entity to be pushable on contact, like ships or
	 * minecarts.
	 */
	@Nullable
	 ...
	 * (e.g.) ships solid. Return null if this entity is not solid. For general
	 * purposes, use {@link #width} and {@link #height}.
	 * 
	...
	/**
	 * Decides how much the ship should be gliding on the land (based on any
	 * slippery blocks)
	 */
	...
	/**
	 * Applies this ship's yaw to the given entity. Used to update the orientation
	 * of its passenger.
	 */
	 ...
	 * "drives" the vehicle. For example, Pigs, Horses, and Ships are generally
