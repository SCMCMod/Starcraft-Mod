...
public class BlockShakurasFarmland extends BlockFarmland
{
	...
	public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
	{
		...
		if (!this.hasWater(worldIn, pos) && !worldIn.isRainingAt(pos.up()))
		{
			...
			{
				worldIn.setBlockState(pos, BlockHandler.DIRT_SHAKURAS.getDefaultState());
			}
		} else if (i < 7)
		{
	...
	public void neighborChanged(IBlockState state, World world, BlockPos pos, Block block, BlockPos fromPos)
	{
		...
		{
			world.setBlockState(pos, BlockHandler.DIRT_SHAKURAS.getDefaultState());
		}
	}
	...
	{
		return BlockHandler.DIRT_SHAKURAS.getItemDropped(BlockHandler.DIRT_SHAKURAS.getDefaultState(), rand, fortune);
	}

	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(BlockHandler.DIRT_SHAKURAS);
	}
