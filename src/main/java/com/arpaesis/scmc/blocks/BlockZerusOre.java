...
public class BlockZerusOre extends SCBlock
{
	...
	{
		return this == BlockHandler.ORE_COAL_ZERUS ? Items.COAL
				: (this == BlockHandler.ORE_DIAMOND_ZERUS ? Items.DIAMOND
						: this == BlockHandler.ORE_PHOSPHORUS_ZERUS ? ItemHandler.PHOSPHORUS : (this == BlockHandler.ORE_LAPIS_ZERUS ? Items.DYE : (this == BlockHandler.ORE_RICHMINERAL_ZERUS || this == BlockHandler.ORE_MINERAL_ZERUS ? ItemHandler.MINERAL_SHARD : Item.getItemFromBlock(this))));
	}
