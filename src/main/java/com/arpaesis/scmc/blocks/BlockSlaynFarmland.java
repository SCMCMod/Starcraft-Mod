 ...
 * @author Ocelot5836
 */
public class BlockSlaynFarmland extends BlockFarmland
{

	public BlockSlaynFarmland()
	{
		this.setTranslationKey("slayn.farmland");
		this.setRegistryName("slayn.farmland");
	...
	public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
	{
		...
		if (!this.hasWater(worldIn, pos) && !worldIn.isRainingAt(pos.up()))
		{
			...
			{
				worldIn.setBlockState(pos, BlockHandler.DIRT_SLAYN.getDefaultState());
			}
		} else if (i < 7)
		{
	...
	public void neighborChanged(IBlockState state, World world, BlockPos pos, Block block, BlockPos fromPos)
	{
		...
		{
			world.setBlockState(pos, BlockHandler.DIRT_SLAYN.getDefaultState());
		}
	}
	...
	{
		return BlockHandler.DIRT_SLAYN.getItemDropped(BlockHandler.DIRT_SLAYN.getDefaultState(), rand, fortune);
	}

	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(BlockHandler.DIRT_SLAYN);
	}
