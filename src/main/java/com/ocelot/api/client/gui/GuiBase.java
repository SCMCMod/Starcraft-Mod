 ...
 * </br>
 * Allows for a basic gui that handles most of the work and errors in a normal
 * gui.
 * 
 * @author Ocelot5836
 */
...
public abstract class GuiBase extends GuiScreen
{
	...
	/**
	 * Constructs a gui with the specified width, height, and whether or not to
	 * render the background behind it.
	 * 
	 * @param xSize The width of the gui
	 * @param ySize The height of the gui
	 * @param renderDefaultBackground Whether or not to render the black background
	 *        behind the gui
	 */
