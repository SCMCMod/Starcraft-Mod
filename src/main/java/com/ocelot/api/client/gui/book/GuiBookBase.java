...
public abstract class GuiBookBase extends GuiBase
{
	 ...
	 * 
	 * @param xSize The width of the book
	 * @param ySize The height of the book
	 */
	 ...
	 * @param width The maximum width the text can be at
	 ...
	 * 
	 * @param string The string to check for illegal characters
