package com.hypeirochus.api.client.render.model;
...
public abstract class Model extends ModelBase
{
	 ...
	 * @param rotateAngleY - Angle by which the model will rotate in the Y
	 *        direction.
	 * @param rotateAngleZ - Angle by which the model will rotate in the Z
	 *        direction.
	 */
	 ...
	 * @param swingPrev - The previous tick's arm swing progress of the Entity being
	 *        rendered.
	 ...
	 * @param swingProgressPrev - The previous tick's arm swing progress of the
	 ...
	 * 
	 * @param modelClass - A class extending ModelBaseExtension which will be
	 *        instantaniated.
	 * @return Instance of the class specified in the modelClass parameter.
	 */
	...
	{
		float yawOffset = SCMathHelper.interpolateRotation(base.prevRenderYawOffset, base.renderYawOffset, AccessHandler.getPartialTicks());
		float yawHead = SCMathHelper.interpolateRotation(base.prevRotationYawHead, base.rotationYawHead, AccessHandler.getPartialTicks());
