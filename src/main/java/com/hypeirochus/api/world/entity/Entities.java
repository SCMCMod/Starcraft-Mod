...
public class Entities
{
	...
	{
		ArrayList<BlockPos> potentialLocations = com.hypeirochus.api.world.block.Blocks.getCoordDataInRangeIncluding((int) around.getX(), (int) around.getY(), (int) around.getZ(), 2, toCheck.world, Blocks.AIR);
