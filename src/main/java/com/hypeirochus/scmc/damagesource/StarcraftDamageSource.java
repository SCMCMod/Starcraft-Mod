...
public class StarcraftDamageSource extends DamageSource {
	...
	public ITextComponent getDeathMessage(EntityLivingBase attacker) {
        ...
        return entitylivingbase != null && I18n.hasKey(playerMessage) ? new TextComponentTranslation(playerMessage, new Object[] {attacker.getDisplayName(), entitylivingbase.getDisplayName()}) : new TextComponentTranslation(defaultMessage, new Object[] {attacker.getDisplayName()});
	}
}