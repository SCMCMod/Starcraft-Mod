...
public class Library {
	...
	public static final String	CLIENT_SIDE_PROXY	= "com.hypeirochus.scmc.proxy.ClientProxy";
	public static final String	SERVER_SIDE_PROXY	= "com.hypeirochus.scmc.proxy.ServerProxy";
