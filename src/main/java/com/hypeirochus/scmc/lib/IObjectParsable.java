...
public interface IObjectParsable {
	...
	/**
	 * Parses a byte from an obj. If the obj is not a string or proper value, it calls {@link #onParseFail(byte)}.
	 * 
	 * @param obj
	 *            The obj to parse
	...
	/**
	 * Parses a short from an obj. If the obj is not a string or proper value, it calls {@link #onParseFail(byte)}.
	 * 
	 * @param obj
	 *            The obj to parse
	 * @return The parsed value
	...
	/**
	 * Parses a int from an obj. If the obj is not a string or proper value, it calls {@link #onParseFail(byte)}.
	 * 
	 * @param obj
	 *            The obj to parse
	 * @return The parsed value
	...
	/**
	 * Parses a float from an obj. If the obj is not a string or proper value, it calls {@link #onParseFail(byte)}.
	 * 
	 * @param obj
	 *            The obj to parse
	 * @return The parsed value
	...
	/**
	 * Parses a double from an obj. If the obj is not a string or proper value, it calls {@link #onParseFail(byte)}.
	 * 
	 * @param obj
	 *            The obj to parse
	 * @return The parsed value
	...
	/**
	 * Parses a long from an obj. If the obj is not a string or proper value, it calls {@link #onParseFail(byte)}.
	 * 
	 * @param obj
	 *            The obj to parse
	 * @return The parsed value
	...
	/**
	 * Parses a boolean from an obj. If the obj is not a string or proper value, it calls {@link #onParseFail(byte)}.
	 * 
	 * @param obj
	 *            The obj to parse
	 * @return The parsed value
