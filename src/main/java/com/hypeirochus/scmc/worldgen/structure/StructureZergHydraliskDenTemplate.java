...
public class StructureZergHydraliskDenTemplate extends SCWorldGenerator implements INBTStructure, IObjectParsable {

	public static final String STRUCTURE_NAME = "zerg.hydralisk_den";

	private boolean checkSpawnPosition;

	public StructureZergHydraliskDenTemplate() {
