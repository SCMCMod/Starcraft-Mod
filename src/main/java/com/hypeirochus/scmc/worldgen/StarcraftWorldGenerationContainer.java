...
public class StarcraftWorldGenerationContainer extends StarcraftGenerator {
	...
	public void generateSpace(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
		...
		if (this.generationCompleted == false) {
			...
			/** Char **/
			this.runMultisurfacePlanetGenerator(MULTISURFACE_PLANET_TEMPLATE, ConfigHandler.INT_DIMENSION_CHAR, 21, 31, MetaBlockHandler.PLANET_SURFACE.getStateFromMeta(14), MetaBlockHandler.PLANET_SURFACE.getStateFromMeta(8), world, random, 0, 0, 0, new BlockPos(-1515, 128, 17776));
			/** Char's moons **/
			...
			/** Shakuras **/
			this.runMultisurfacePlanetGenerator(MULTISURFACE_PLANET_TEMPLATE, ConfigHandler.INT_DIMENSION_SHAKURAS, 21, 31, MetaBlockHandler.PLANET_SURFACE.getStateFromMeta(0), MetaBlockHandler.PLANET_SURFACE.getStateFromMeta(5), world, random, 0, 0, 0, new BlockPos(6666, 128, 18180));

			/** Aiur **/
			this.runMultisurfacePlanetGenerator(MULTISURFACE_PLANET_TEMPLATE, ConfigHandler.INT_DIMENSION_AIUR, 41, 51, MetaBlockHandler.PLANET_SURFACE.getStateFromMeta(0), MetaBlockHandler.PLANET_SURFACE.getStateFromMeta(4), world, random, 0, 0, 0, new BlockPos(4444, 128, 17365));

			/** Slayn **/
			this.runMultisurfacePlanetGenerator(MULTISURFACE_PLANET_TEMPLATE, ConfigHandler.INT_DIMENSION_SLAYN, 31, 41, MetaBlockHandler.PLANET_SURFACE.getStateFromMeta(14), MetaBlockHandler.PLANET_SURFACE.getStateFromMeta(10), world, random, 0, 0, 0, new BlockPos(7000, 128, 16666));

			/** Korhal **/
			this.runMultisurfacePlanetGenerator(MULTISURFACE_PLANET_TEMPLATE, ConfigHandler.INT_DIMENSION_SHAKURAS, 35, 45, MetaBlockHandler.PLANET_SURFACE.getStateFromMeta(14), MetaBlockHandler.PLANET_SURFACE.getStateFromMeta(5), world, random, 0, 0, 0, new BlockPos(3290, 128, 11000));
