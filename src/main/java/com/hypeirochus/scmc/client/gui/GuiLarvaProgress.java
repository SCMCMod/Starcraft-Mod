...
//		this.mc.fontRenderer.drawString(I18n.format("gui.larva_progress"), this.xSize / 2 - this.mc.fontRendererObj.getStringWidth(I18n.format("gui.larva_progress")) / 2, 6, 4210752);
//	}
//
//	@Override
