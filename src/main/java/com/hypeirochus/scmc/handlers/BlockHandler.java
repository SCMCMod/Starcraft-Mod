...
public class BlockHandler
{
	...
	private static void instantiate()
	{
		...
		// Char
		COBBLESTONE_CHAR = new StarcraftBlock("char.cobblestone", RegistryType.FULL, Material.ROCK, MapColor.BLACK).setBlockHarvestLevel("pickaxe", 0).setCreativeTab(SCCreativeTabs.MISC).setHardness(2).setResistance(10);
		STONE_CHAR = new StarcraftBlockCustomDrop("char.stone", RegistryType.FULL, Material.ROCK, MapColor.BLACK, new ItemStack(COBBLESTONE_CHAR)).setBlockHarvestLevel("pickaxe", 0).setHardness(1.5f).setResistance(10).setCreativeTab(SCCreativeTabs.MISC);
		FARMLAND_CHAR = new BlockCharFarmland();
		DIRT_CHAR = new StarcraftDirt("char.dirt", MapColor.BLACK, FARMLAND_CHAR.getDefaultState());
		GRAVEL_CHAR = new StarcraftGravel("char.gravel", RegistryType.FULL, Material.GROUND, MapColor.BLACK, 0x000000).setSoundType(SoundType.GROUND).setHardness(0.6f).setResistance(1).setCreativeTab(SCCreativeTabs.MISC);
		...
		// Shakuras
		COBBLESTONE_SHAKURAS = new StarcraftBlock("shakuras.cobblestone", RegistryType.FULL, Material.ROCK, MapColor.BLUE).setBlockHarvestLevel("pickaxe", 0).setCreativeTab(SCCreativeTabs.MISC).setHardness(2).setResistance(10);
		STONE_SHAKURAS = new StarcraftBlockCustomDrop("shakuras.stone", RegistryType.FULL, Material.ROCK, MapColor.LIGHT_BLUE, new ItemStack(COBBLESTONE_SHAKURAS)).setHardness(1.5f).setResistance(10).setCreativeTab(SCCreativeTabs.MISC);
		...
		GRAVEL_SHAKURAS = new StarcraftGravel("shakuras.gravel", RegistryType.FULL, Material.GROUND, MapColor.LIGHT_BLUE, 0x55539B).setSoundType(SoundType.GROUND).setHardness(0.6f).setResistance(1).setCreativeTab(SCCreativeTabs.MISC);
		SAND_SHAKURAS = new StarcraftBlockFalling("shakuras.sand", RegistryType.FULL, Material.SAND, MapColor.LIGHT_BLUE, 6724056).setSoundType(SoundType.SAND).setCreativeTab(SCCreativeTabs.MISC).setHardness(0.5f).setResistance(0.83f);
		...
		// Zerus
		COBBLESTONE_ZERUS = new StarcraftBlock("zerus.cobblestone", RegistryType.FULL, Material.ROCK, MapColor.BROWN).setBlockHarvestLevel("pickaxe", 0).setCreativeTab(SCCreativeTabs.MISC).setHardness(2).setResistance(10);
		STONE_ZERUS = new StarcraftBlockCustomDrop("zerus.stone", RegistryType.FULL, Material.ROCK, MapColor.BROWN, new ItemStack(COBBLESTONE_ZERUS)).setHardness(1.5f).setResistance(10).setCreativeTab(SCCreativeTabs.MISC);
		...
		GRAVEL_ZERUS = new StarcraftGravel("zerus.gravel", RegistryType.FULL, Material.GROUND, MapColor.BROWN, 0x55539B).setSoundType(SoundType.GROUND).setHardness(0.6f).setResistance(1).setCreativeTab(SCCreativeTabs.MISC);
		SAND_ZERUS = new StarcraftBlockFalling("zerus.sand", RegistryType.FULL, Material.SAND, MapColor.BROWN, 6724056).setSoundType(SoundType.SAND).setCreativeTab(SCCreativeTabs.MISC).setHardness(0.5f).setResistance(0.83f);
		...
		// Slayn
		COBBLESTONE_SLAYN = new StarcraftBlock("slayn.cobblestone", RegistryType.FULL, Material.ROCK, MapColor.BLACK).setBlockHarvestLevel("pickaxe", 0).setCreativeTab(SCCreativeTabs.MISC).setHardness(2).setResistance(10);
		STONE_SLAYN = new StarcraftBlockCustomDrop("slayn.stone", RegistryType.FULL, Material.ROCK, MapColor.BLACK, new ItemStack(COBBLESTONE_SLAYN)).setBlockHarvestLevel("pickaxe", 0).setHardness(1.5f).setResistance(10).setCreativeTab(SCCreativeTabs.MISC);
		...
		SAND_SLAYN = new StarcraftBlockFalling("slayn.sand", RegistryType.FULL, Material.SAND, MapColor.BLACK, 6724056).setSoundType(SoundType.SAND).setCreativeTab(SCCreativeTabs.MISC).setHardness(0.5f).setResistance(0.83f);
		GRAVEL_SLAYN = new StarcraftGravel("slayn.gravel", RegistryType.FULL, Material.GROUND, MapColor.BLACK, 0x000000).setSoundType(SoundType.GROUND).setHardness(0.6f).setResistance(1).setCreativeTab(SCCreativeTabs.MISC);
		...
		// Korhal
		CITY_STONE_KORHAL = new StarcraftBlock("korhal.stone.city", RegistryType.FULL, Material.ROCK, MapColor.BLACK).setBlockHarvestLevel("pickaxe", 0).setHardness(1.5f).setResistance(10.0f).setCreativeTab(SCCreativeTabs.MISC);
		...
		// Terran
		TERRAN_WARNING_TAPE = new StarcraftBlock("terran.warningtape", RegistryType.FULL, Material.IRON, MapColor.YELLOW).setSoundType(SoundType.METAL).setHardness(3.5f).setResistance(10.0f).setCreativeTab(SCCreativeTabs.TERRAN);
		TERRAN_METAL = new BlockTerranMetal();
		NEOSTEEL_METAL = new BlockNeosteel();
		PARISTEEL_METAL = new BlockParisteel();

		// Terran Cores
		CORE_BARRACKS = new StarcraftBlock("terran.barrackscore", RegistryType.FULL, Material.IRON, MapColor.BLUE).setBlockHarvestLevel("pickaxe", 2).setHardness(15.0F).setResistance(15.0F).setCreativeTab(SCCreativeTabs.TERRAN);
		CORE_COMMANDCENTER = new StarcraftBlock("terran.commandcentercore", RegistryType.FULL, Material.IRON, MapColor.BLUE).setBlockHarvestLevel("pickaxe", 2).setHardness(15.0F).setResistance(15.0F).setCreativeTab(SCCreativeTabs.TERRAN);
