...
public class RecipeFlamethrowerFuel extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> implements IRecipe {
	...
	public ItemStack getCraftingResult(InventoryCrafting inv) {
		return ItemMagazine.getDefaultStack(MetaHandler.BulletMagazineType.FLAMETHROWER.getID());
	}
