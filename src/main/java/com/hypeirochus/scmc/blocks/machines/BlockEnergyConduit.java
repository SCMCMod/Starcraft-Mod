...
import com.hypeirochus.scmc.tileentity.TileEntityEnergyConduit;
...
public class BlockEnergyConduit extends EnergyBlock implements ITileEntityProvider
{
	public BlockEnergyConduit(String name) { super(name, Material.IRON); }
