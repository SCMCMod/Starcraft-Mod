 ...
 */
public class BlockProtossMetalT3 extends StarcraftBlock implements IMetaBlockName, IMetaRenderHandler
{
	...
	{
		super("protoss.metal.3", RegistryType.META, Material.IRON);
	...
	{
		return "protoss.metal.3." + ProtossMetalType.values()[meta].getName();
	}
}