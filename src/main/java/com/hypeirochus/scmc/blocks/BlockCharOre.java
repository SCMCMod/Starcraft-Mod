...
public class BlockCharOre extends StarcraftBlock {
	 ...
	 */
	public BlockCharOre(String name, RegistryType type, Material material, MapColor color, int level) {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return this == BlockHandler.ORE_COAL_CHAR ? Items.COAL : (this == BlockHandler.ORE_DIAMOND_CHAR ? Items.DIAMOND : (this == BlockHandler.ORE_LAPIS_CHAR ? Items.DYE : (this == BlockHandler.ORE_PHOSPHORUS_CHAR ? ItemHandler.PHOSPHORUS : (this == BlockHandler.ORE_RICHMINERAL_CHAR || this == BlockHandler.ORE_MINERAL_CHAR ? ItemHandler.MINERAL_SHARD : Item.getItemFromBlock(this)))));
	}
