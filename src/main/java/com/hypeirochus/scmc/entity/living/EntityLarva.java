...
public class EntityLarva extends EntityZergPassive {
	...
	// }
	//
	// List<AxisAlignedBB> list1 = world.getCollisionBoxes(this, getEntityBoundingBox().grow(x, y, z));
	...
	// y = stepHeight;
	// List<AxisAlignedBB> list = world.getCollisionBoxes(this, getEntityBoundingBox().grow(d3, y, d5));
	// AxisAlignedBB axisalignedbb2 = getEntityBoundingBox();
	// AxisAlignedBB axisalignedbb3 = axisalignedbb2.grow(d3, 0, d5);
	// double d9 = y;
	// int l = 0;
	//
